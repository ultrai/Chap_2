...
import caffe
net = caffe.Net('FCN2_AMD_deploy.prototxt', 'FCN2_AMD_iter_150000.caffemodel', caffe.TEST)
#caffe.set_mode_gpu()
#caffe.set_device(1)
...
Labels = f['Label'].reshape((512,599,1,220)).swapaxes(0,3).swapaxes(1,2).astype('float32')-1
...
Labels_AD = f['Label_AD'].reshape((512,599,1,220)).swapaxes(0,3).swapaxes(1,2).astype('float32')-1

Conturs = f['Contour'].reshape((512,599,1,220)).swapaxes(0,3).swapaxes(1,2).astype('float32')-1
Conturs1 = f['Contour1'].reshape((512,599,1,220)).swapaxes(0,3).swapaxes(1,2).astype('float32')-1
Conturs2 = f['Contour2'].reshape((512,599,1,220)).swapaxes(0,3).swapaxes(1,2).astype('float32')-1
Conturs_AD = f['Contour_AD'].reshape((512,599,1,220)).swapaxes(0,3).swapaxes(1,2).astype('float32')-1
...
Labels = view_as_blocks(Labels[:,0,:,:] , block_shape=(1,128,1)).reshape(Labels.shape[0]*4,512,128).swapaxes(1,2)
Labels_AD = view_as_blocks(Labels_AD[:,0,:,:] , block_shape=(1,128,1)).reshape(Labels_AD.shape[0]*4,512,128).swapaxes(1,2)
...
CM = np.zeros((Images.shape[0],4))
CMc = np.zeros((Images.shape[0],9))
CMd = np.zeros((Images.shape[0],4))
